 ...
 */
final class Version20250418190131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS alert_meteo (id INT AUTO_INCREMENT NOT NULL, creatd_at DATETIME NOT NULL, type TINYINT(1) NOT NULL, online TINYINT(1) NOT NULL, level INT NOT NULL, message LONGTEXT NOT NULL, pictogramme VARCHAR(255) DEFAULT NULL, code_phenomene INT DEFAULT NULL, origine VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vigilance_meteofrance (
            id INT AUTO_INCREMENT NOT NULL, 
            domaine_id INT NOT NULL, 
            domaine_name VARCHAR(255) NOT NULL, 
            bloc_title LONGTEXT NOT NULL, 
            bloc_id LONGTEXT NOT NULL, 
            term_names VARCHAR(255) DEFAULT NULL, 
            start_time DATETIME DEFAULT NULL, 
            end_time DATETIME DEFAULT NULL, 
            risk_name VARCHAR(255) DEFAULT NULL, 
            risk_code INT DEFAULT NULL, 
            risk_color VARCHAR(255) DEFAULT NULL, 
            risk_level INT DEFAULT NULL, 
            text_1 LONGTEXT DEFAULT NULL, 
            text_2 LONGTEXT DEFAULT NULL, 
            bold_text_1 VARCHAR(255) DEFAULT NULL, 
            bold_text_2 VARCHAR(255) DEFAULT NULL, 
            text_3 LONGTEXT DEFAULT NULL, 
            text_4 LONGTEXT DEFAULT NULL, 
            text_5 LONGTEXT DEFAULT NULL, 
            text_6 LONGTEXT DEFAULT NULL, 
            update_date DATETIME NOT NULL, 
            hazard_code INT DEFAULT NULL, 
            text21 LONGTEXT DEFAULT NULL, 
            text22 LONGTEXT DEFAULT NULL, 
            text23 LONGTEXT DEFAULT NULL, 
            text24 LONGTEXT DEFAULT NULL, 
            text25 LONGTEXT DEFAULT NULL, 
            text26 LONGTEXT DEFAULT NULL, 
            PRIMARY KEY(id)
