 ...
 */
final class Version20240208184529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE station_direct ADD CONSTRAINT FK_EFF506A8CC52C971 FOREIGN KEY (stationid_id) REFERENCES station_meteos (id)');
